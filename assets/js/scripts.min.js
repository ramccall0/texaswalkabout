...
if(ratio!==false){let ratioValue=(ratio*100)+'%';wrappers[i].setAttribute('style','--embed-aspect-ratio:'+ratioValue);}}})();(function(){let layoutButtons=document.querySelectorAll('.switchers__item');let contentWrapper=document.querySelector('.l-grid');let articles=contentWrapper.querySelectorAll('.c-card');if(!contentWrapper||!layoutButtons.length||!articles.length){return;}
...
if(savedLayout==='rows'){setRowsLayout();}}},0);},false);})();(function(){let shareButton=document.querySelector('.js-post__share-button');let sharePopup=document.querySelector('.js-post__share-popup');if(shareButton){sharePopup.addEventListener('click',function(e){e.stopPropagation();});shareButton.addEventListener('click',function(e){e.preventDefault();e.stopPropagation();sharePopup.classList.toggle('is-visible');});document.body.addEventListener('click',function(){sharePopup.classList.remove('is-visible');});}
